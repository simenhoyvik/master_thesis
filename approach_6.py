...
from pytorch import init_device, predict_approach_3, train_approach6, train_general
from transformers import BertModel, BertTokenizer, AlbertModel, RobertaModel, AlbertTokenizer, RobertaTokenizer
from transformers import logging

from utils import create_dir_if_not_exists, get_model_type, get_tokenizer, preprocess_df_bert_3, preprocess_df_bert_6
...
class Approach6:
    ...
    def train_all(self, text_columns, max_len, pre_trained_model_name, train, val, learning_rate, max_abstract_length, sub_approach):
    ...
    def load_model(self, path):
        ...
        model = Approach6Model(1, checkpoint["pre_trained_model_name"], checkpoint["model_type"])
