...
from utils import create_dir_if_not_exists, get_model_type, get_tokenizer, preprocess_df_bert_3
...
class Approach3:
    def __init__(self, batch_size, n_epochs, verbose, device, force_restart, early_stopping, freeze, dropout_value):
        ...
        self.base_path = "/models/approach3/"
    ...
    def train_bert_model(self, text_columns, max_len, pre_trained_model_name, train, val, learning_rate, cleaning_type, max_abstract_length):
        ...
        model_name = f'{text_columns}-{pre_trained_model_name_path}-{learning_rate}-cleaning-{cleaning_type}-batch-size-{self.batch_size}-max_abstract_len-{max_abstract_length}-dropout-{self.dropout_value}'
    ...
    def train_and_evaluate_all(self, text_columns, max_len, pre_trained_model_name, train, val, test, learning_rate, max_abstract_length):
        ...
        for i, data in pre_trained_model_name.items():
            ...
            self.evaluate(text_columns, model_name, max_len, test, learning_rate, cleaning_type, max_abstract_length)
    ...
    def evaluate(self, text_combination, pre_trained_model_name, max_len, test, learning_rate, cleaning_type, max_abstract_length):
        ...
        path = "models/approach3/" + model_name +"/best_model.pt"
